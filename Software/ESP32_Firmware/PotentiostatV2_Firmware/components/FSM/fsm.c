        ...
        case STATE_PREPARING:
            ...
            else if (strncmp(cmd, "CONF_CPE:", 8) == 0)
            {
                ...
                int res = sscanf(cmd + strlen(CMD_CONF_CPE), "%hd, %f, %lld, %hhd",                                                      
                                 &experiment_config.CPE.applied_pot_mv, &experiment_config.CPE.sample_interval_s,                                       // FALTA VER EL PREACONDICIONAMIENTO QUE
                                 &experiment_config.CPE.time_limit, &experiment_config.CPE.time_unit);                                         // QUE SE DEBE TENER EN CUENTA ACA
